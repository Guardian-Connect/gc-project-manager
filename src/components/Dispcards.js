        ...
        {site.disp1 != null && (
          <div className="disp">
            <Typography variant="h4">
              <div>{site.disp1}</div>{" "}
              <div className="grades">{site.grades1}</div>
            </Typography>
          </div>
        )}
        {site.disp2 != null && (
          <div className="disp">
            <Typography variant="h4">
              <div>{site.disp2}</div>{" "}
              <div className="grades">{site.grades2}</div>
            </Typography>
          </div>
        )}
        {site.disp3 != null && (
          <div className="disp">
            <Typography variant="h4">
              <div>{site.disp3}</div>{" "}
              <div className="grades">{site.grades3}</div>
            </Typography>
          </div>
        )}
        {site.disp4 != null && (
          <div className="disp">
            <Typography variant="h4">
              <div>{site.disp4}</div>{" "}
              <div className="grades">{site.grades4}</div>
            </Typography>
          </div>
        )}
        {site.disp5 != null && (
          <div className="disp">
            <Typography variant="h4">
              <div>{site.disp5}</div>{" "}
              <div className="grades">{site.grades5}</div>
            </Typography>
          </div>
        )}
        {site.disp6 != null && (
          <div className="disp">
            <Typography variant="h4">
              <div>{site.disp6}</div>{" "}
              <div className="grades">{site.grades6}</div>
            </Typography>
          </div>
        )}
        {site.disp7 != null && (
          <div className="disp">
            <Typography variant="h4">
              <div>{site.disp7}</div>{" "}
              <div className="grades">{site.grades7}</div>
            </Typography>
          </div>
        )}
        {site.disp8 != null && (
          <div className="disp">
            <Typography variant="h4">
              <div>{site.disp8}</div>{" "}
              <div className="grades">{site.grades8}</div>
            </Typography>
          </div>
        )}
        {site.disp9 != null && (
          <div className="disp">
            <Typography variant="h4">
              <div>{site.disp9}</div>{" "}
              <div className="grades">{site.grades9}</div>
            </Typography>
          </div>
        )}
        {site.disp10 != null && (
